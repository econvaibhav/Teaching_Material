...
This Reddit post does a great job at explaining what a regression is: [What is a Regression?](https://www.reddit.com/r/explainlikeimfive/comments/10t73h2/eli5_what_is_a_regression_analysis_and_what_is_an/). 

Here is a another resource: [Ultimate guide to Regression](https://www.graphpad.com/guides/the-ultimate-guide-to-linear-regression).

Here is a great video which talks about linear regressions: 

{{< video https://www.youtube.com/watch?v=eYTumjgE2IY 
    title="Learn Statistical Regression in 40 mins!"
    width="600" 
    height="400" >}}

Here are some interesting sources which explain linear regressions well:

- One of the best explainations in [Chapter 7 of R for Health Data Science](https://argoshare.is.ed.ac.uk/healthyr_book/regression.html)

- Another good source: [MLU Visual Explainations](https://mlu-explain.github.io/linear-regression/)


For Logistic Regression, here are some really amazing videos by [StatQuest by Josh Starmer on Logistic Regressions](https://www.youtube.com/@statquest). If you are interested you can continue on the logistic regression series following the videos!

{{< video https://www.youtube.com/watch?v=yIYKR4sgzI8&t
  title="StatQuest: Logistic Regression"
    width="600" 
    height="400" >}}
    
    
{{< video https://www.youtube.com/watch?v=ARfXDSkQf1Y 
    title="Odds and Log(Odds), Clearly Explained!!!"
    width="600" 
    height="400" >}}

Furthermore, this link covers everything related to logistic regressions and explainations for all the outputs generated: [Chapter 9 in R for Health Data Science](https://argoshare.is.ed.ac.uk/healthyr_book/chap09-h1.html)
...
# 4. Adding Socio-Demographic Controls
...
{{< video https://www.youtube.com/watch?v=Gvhkp-Yw65U 
    title="Dplyr Essentials (easy data manipulation in R): select, mutate, filter, group_by, summarise, & more"
    width="600" 
    height="400" >}}
...
![R Bingo is DONE!](R_BINGO_done.png)


## Next Class: Tables and Graphs
